...
let currentProjectId =
  (_a = currentUrl.split("kanban")[1]) === null || _a === void 0
    ? void 0
    : _a.split("?")[0];
if (!currentProjectId) {
...
function getNextStatus(currentStatus) {
  ...
  const nextColumn = listOfColumn.find((ul) => {
    var _a, _b;
    return (
      ((_b =
        (_a = ul.querySelector("h1.title")) === null || _a === void 0
          ? void 0
          : _a.textContent) === null || _b === void 0
        ? void 0
        : _b.trim()) === `${nextColumnTitle}`
    );
  });
  if (!nextColumn) {
  ...
  const maxDocumentCount =
    Number(
      (_b =
        (_a = nextColumn.querySelector("span.max-documents")) === null ||
        _a === void 0
          ? void 0
          : _a.textContent) === null || _b === void 0
        ? void 0
  ...
  if (!maxDocumentCount) throw new Error("404 nextColumn was not found");
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      const nextColumn = listOfColumn.find((column) => {
        ...
        return (
          ((_b =
            (_a = column.querySelector("h1.title")) === null || _a === void 0
              ? void 0
              : _a.textContent) === null || _b === void 0
            ? void 0
            : _b.trim()) === `${nextStatus}`
      ...
      const maxDocuments =
        (_c =
          (_b =
            (_a = nextColumn.querySelector(`.max-documents`)) === null ||
            _a === void 0
              ? void 0
              : _a.textContent) === null || _b === void 0
            ? void 0
            : _b.split(" ")[1]) !== null && _c !== void 0
          ? _c
          : 0;
      const currentDocuments =
        (_f =
          (_e =
            (_d = nextColumn.querySelector(`.document-count`)) === null ||
            _d === void 0
              ? void 0
              : _d.textContent) === null || _e === void 0
            ? void 0
            : _e.split(" ")[1]) !== null && _f !== void 0
          ? _f
          : 0;
      ...
      const targetContainer = targetColumn.querySelector(
        ".documents-container"
      );
      if (!targetContainer) {
...
function loadFromLocalStorage(emittedBoard, emitted) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let listOfColumn = [];
    listOfColumn = yield Promise.all(
    ...
    columns: Array.from(document.querySelectorAll("div ul.dragColumn")).map(
      (column, columnIndex) => {
        ...
        const documents = Array.from(
          ...
          let labels =
            (_b =
              (_a = el.querySelector(".labelsList")) === null || _a === void 0
                ? void 0
                : _a.textContent) !== null && _b !== void 0
              ? _b
              : "";
          ...
          return {
            id: el.id,
            title:
              (_c = el.querySelector("h2")) === null || _c === void 0
                ? void 0
                : _c.textContent,
            description:
              (_d = el.querySelector("p")) === null || _d === void 0
                ? void 0
                : _d.textContent,
            backgroundColor: el.style.backgroundColor || "#08CF65",
            status,
            assignee:
              ((_e = el.querySelector(".assignedTo")) === null || _e === void 0
                ? void 0
                : _e.textContent) || "Unassigned",
            labels: Array.from(
              ((_g =
                (_f = el.querySelector(".labelsList")) === null || _f === void 0
                  ? void 0
                  : _f.textContent) !== null && _g !== void 0
                ? _g
                : ""
              )
                .split(" ")
        ...
        return {
          id: indexedColumn.id,
          title:
            (_a = indexedColumn.querySelector(".title")) === null ||
            _a === void 0
              ? void 0
              : _a.textContent,
          ...
          maxDocuments:
            (_c =
              (_b = indexedColumn.querySelector("span.max-documents")) ===
                null || _b === void 0
                ? void 0
...
function createDocumentFromSaved(savedDoc, columnIndex = 0) {
  ...
  const status =
    (_a = savedDoc.status) !== null && _a !== void 0
      ? _a
      : getStatusForColumn(columnIndex);
  if (!status) {
  ...
  columnDrake = window.dragula([dragparent], {
    moves: (el, container, handle) => {
      ...
      return !!(
        ...
        (handle.tagName === "NAV" ||
          ((_a =
            handle === null || handle === void 0
              ? void 0
              : handle.parentElement) === null || _a === void 0
            ? void 0
            : _a.tagName) === "NAV")
      );
    },
    ...
    accepts: (el, target) => {
      ...
      let isAcolumn =
        (_a =
          ...
          null || _a === void 0
          ? void 0
          : _a.contains("documents-container");
      let currentDocuments =
        (_b =
          target === null || target === void 0 ? void 0 : target.children) ===
          null || _b === void 0
          ? void 0
          : _b.length;
      let maxDocuments =
        (_c = target.nextElementSibling) === null || _c === void 0
          ? void 0
          : _c.querySelector(".max-documents").textContent.split(" ")[1];
      if (maxDocuments === "∞") {
...
function deleteDocument(docID) {
  ...
  if (theDoomedDocument) {
    (_a =
      theDoomedDocument === null || theDoomedDocument === void 0
        ? void 0
        : theDoomedDocument.parentNode) === null || _a === void 0
      ? void 0
      : _a.removeChild(theDoomedDocument);
    saveToLocalStorage();
  }
...
function createDocumentPopup(columnData) {
      ...
      (_b =
        (_a =
          document === null || document === void 0
            ? void 0
            : document.getElementById(`${columnData}`)) === null ||
        _a === void 0
          ? void 0
          : _a.querySelector(`.max-documents`)) === null || _b === void 0
        ? void 0
        : _b.textContent) === null || _c === void 0
      ? void 0
      : _c.split(" ")[1];
  const currentDocuments =
    (_f =
      (_e =
        ...
        _d === void 0
          ? void 0
          : _d.querySelector(`.document-count`)) === null || _e === void 0
        ? void 0
  ...
  if (documentTitle !== null) {
    documentTitle === null || documentTitle === void 0
      ? void 0
      : documentTitle.focus();
  }
...
function init(emittedBoard = null, emitted = false) {
  ...
  function handleColumnSubmit(event) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      event.preventDefault();
      const columnContent =
        (_a = document.getElementById("columnContent")) === null ||
        _a === void 0
          ? void 0
          : _a.value;
  ...
  function handleDocumentSubmit(event) {
    ...
    const columnID =
      (_a =
        document === null || document === void 0
          ? void 0
          : document.getElementById("createDoc")) === null || _a === void 0
        ? void 0
        : _a.dataset.id;
    if (!columnID) {
      throw new Error(
    ...
    const columnIndex = parseInt(
      ((_b =
        parentColumn === null || parentColumn === void 0
          ? void 0
          : parentColumn.dataset) === null || _b === void 0
        ? void 0
        : _b.index) || String(0)
    );
    const status = getStatusForColumn(columnIndex);
    const title =
      (_c = document.getElementById("documentTitle").value) !== null &&
      _c !== void 0
        ? _c
        : "Double click to add a Title";
    let description =
      (_e =
        (_d = document.getElementById("documentDescription")) === null ||
        _d === void 0
          ? void 0
    ...
    let documentsContainer =
      parentColumn === null || parentColumn === void 0
        ? void 0
        : parentColumn.querySelector(".documents-container");
